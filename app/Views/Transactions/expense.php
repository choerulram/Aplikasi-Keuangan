    ...
    <form method="get" action="" class="flex flex-wrap gap-2 items-end flex-1">
        ...
        <div class="flex gap-2 items-end">
            ...
            <?php if (!empty($search) || !empty($account) || !empty($category) || !empty($date)): ?>
                <a href="/transactions/expense" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition">Reset</a>
            <?php endif; ?>
        </div>
    </form>
    <button id="btnShowAddExpenseTransactionModal" type="button" class="inline-flex items-center gap-2 px-4 py-2 bg-main text-white rounded-lg shadow hover:bg-highlight transition h-11">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-2 px-2 w-40 text-center border-b border-r border-gray-200">
                            <div class="flex justify-center gap-1">
                                ...
                                <a href="#" onclick='toggleDeleteExpenseTransactionModal(true, { id: "<?= $trx['id'] ?>", deskripsi: "<?= esc($trx['deskripsi']) ?>" })' class="inline-flex items-center px-2 py-1 text-xs font-semibold text-white bg-red-500 rounded hover:bg-red-600" title="Hapus">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
