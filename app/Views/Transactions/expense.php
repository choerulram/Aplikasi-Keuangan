...
<div class="flex flex-wrap items-end gap-2 mb-6">
    ...
    <a href="/transactions/add?type=expense" class="inline-flex items-center gap-2 px-4 py-2 bg-main text-white rounded-lg shadow hover:bg-highlight transition h-11">
