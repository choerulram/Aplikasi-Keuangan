<aside class="bg-light border-r border-gray-200 shadow-md min-h-screen w-60 fixed top-0 left-0 pt-20 px-4 z-10">
    ...
    <ul class="space-y-2">
        ...
        <li><a href="/budgets" class="flex items-center gap-2 block py-2 px-3 rounded transition font-semibold <?= url_is('budgets*') ? 'bg-highlight text-main' : 'hover:bg-highlight text-dark hover:text-main' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
