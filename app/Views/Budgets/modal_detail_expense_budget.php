...
<div id="modalDetailExpenseBudget" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden transition-opacity duration-200">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-4 md:p-6 relative border-t-4 border-blue-500 animate-fadeIn">
    ...
    <div class="flex flex-col items-center text-center">
      ...
      <h2 class="text-lg md:text-xl font-bold mb-4 text-blue-600">Detail Batas Pengeluaran</h2>
    </div>
      ...
      <div class="flex flex-col gap-2 bg-white rounded-lg p-3 md:p-4 border border-gray-200">
        ...
        <div class="flex flex-col gap-1">
          ...
          <div class="flex items-center gap-2">
            <span id="detail_expense_budget_category" class="text-base md:text-lg font-bold text-gray-900"></span>
        ...
        <div class="flex flex-col gap-1 mt-2">
          ...
          <div class="flex items-center gap-1">
            ...
            <span id="detail_expense_budget_periode" class="text-base md:text-base font-semibold text-gray-700"></span>
          </div>
        </div>

        <!-- Batas Pengeluaran -->
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-sm md:text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Batas Pengeluaran</span>
          <span id="detail_expense_budget_amount" class="text-base md:text-lg font-bold text-blue-600"></span>
        </div>

        <!-- Penggunaan -->
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-sm md:text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Penggunaan</span>
          <span id="detail_expense_budget_usage" class="text-base md:text-lg font-bold text-red-600"></span>
        </div>

        <!-- Progress Bar -->
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-sm md:text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Status Penggunaan</span>
          <div class="flex items-center gap-2">
            <div class="flex-1 bg-gray-200 rounded-full h-2.5 overflow-hidden">
              <div id="detail_expense_budget_progress" class="h-full rounded-full"></div>
            </div>
            <span id="detail_expense_budget_percentage" class="text-xs md:text-sm font-medium"></span>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-1 mt-2">
          ...
          <div class="flex items-center gap-1">
            ...
            <span id="detail_expense_budget_user" class="text-base md:text-base font-semibold text-gray-700"></span>
          </div>
        </div>
        <?php endif; ?>
