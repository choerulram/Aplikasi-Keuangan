...
<script>
function toggleDeleteIncomeBudgetModal(show, data = null) {
  const modal = document.getElementById('modalDeleteIncomeBudget');
  if (show) {
    if (data) {
      document.getElementById('delete_income_kategori').textContent = data.nama_kategori;
      const form = document.getElementById('formDeleteIncomeBudget');
