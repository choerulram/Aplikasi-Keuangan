...
<div id="modalAddExpenseBudget" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden transition-opacity duration-200">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-4 md:p-6 relative border-t-4 border-main animate-fadeIn">
    ...
    <div class="flex flex-col items-center text-center">
      ...
      <h2 class="text-lg md:text-xl font-bold mb-4 text-main">Tambah Batas Pengeluaran</h2>
    </div>
    <form id="formAddExpenseBudget" method="POST" action="/budgets/add">
      ...
      <div class="mb-3">
        ...
        <select name="category_id" id="expense_category_id" class="w-full border rounded px-4 py-3 md:px-3 md:py-2 text-base md:text-sm focus:outline-none focus:ring focus:border-main" required>
