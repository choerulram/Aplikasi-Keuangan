...
<div class="container mx-auto px-4 py-6">
    <div class="mb-2">
        <h1 class="text-3xl font-bold text-main tracking-tight drop-shadow-sm mb-4">Pelacakan Pengeluaran</h1>
    </div>
        ...
        <form method="get" action="" class="flex flex-wrap gap-2 items-end flex-1">
            ...
            <div class="flex gap-2 items-end">
                ...
                <?php if (!empty($search) || !empty($category) || !empty($periode)): ?>
                    <a href="/budgets/expense" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition">Reset</a>
                <?php endif; ?>
            </div>
        </form>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-2 px-4 border-b border-r border-gray-200">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm <?= $percentage >= 100 ? 'text-red-600' : 'text-blue-600' ?>"><?= number_format($percentage, 1) ?>%</span>
                            </div>
                        </td>
                        <?php if ($isAdmin): ?>
