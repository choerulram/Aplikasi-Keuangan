...
<div id="modalDetailAccount" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden transition-opacity duration-200">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative border-t-4 border-blue-500 animate-fadeIn">
    ...
    <div class="flex flex-col items-center text-center">
      ...
      <h2 class="text-xl font-bold mb-4 text-blue-600">Detail Akun</h2>
    </div>
    <div class="space-y-5 mt-2">
      <div class="flex flex-col gap-2 bg-white rounded-lg p-4 border border-gray-200">
        <div class="flex flex-col gap-1">
          <span class="text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Nama Akun</span>
          <span id="detail_nama_akun" class="text-lg font-bold text-gray-900"></span>
        </div>
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Tipe Akun</span>
          <span id="detail_tipe_akun_badge"></span>
        </div>
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Saldo Awal</span>
          <span id="detail_saldo_awal" class="text-base text-green-700 font-bold"></span>
        </div>
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Catatan</span>
          <span id="detail_catatan" class="text-base text-gray-700"></span>
        </div>
        <div class="flex flex-col gap-1 mt-2">
          <span class="text-[13px] text-gray-700 font-semibold uppercase tracking-wide">Tanggal Dibuat</span>
          <span id="detail_created_at" class="text-base text-gray-700"></span>
        </div>
      </div>
    </div>
    <div class="flex justify-end mt-8">
      <button type="button" onclick="toggleDetailAccountModal(false)" class="px-5 py-2 rounded-lg bg-blue-500 text-white font-semibold hover:bg-blue-600 transition">Tutup</button>
    </div>
  </div>
</div>
