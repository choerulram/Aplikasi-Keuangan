...
<div id="modalAddCategory" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden transition-opacity duration-200">
  <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative border-t-4 border-main animate-fadeIn">
    ...
    <div class="flex flex-col items-center text-center">
      ...
      <h2 class="text-xl font-bold mb-4 text-main">Tambah Kategori Pemasukan</h2>
    </div>
    <form id="formAddCategory" method="POST" action="/categories/income/add">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="nama_kategori" placeholder="Contoh: Gaji, Penjualan, Investasi" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-main" required>
      </div>
      <input type="hidden" name="tipe" value="income">
      <div class="flex justify-end mt-4">
        <button type="button" onclick="toggleAddCategoryModal(false)" class="px-4 py-2 mr-2 rounded bg-gray-200 text-gray-700 hover:bg-gray-300">Batal</button>
