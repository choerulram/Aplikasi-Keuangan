...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex flex-wrap items-end gap-2 mb-6">
        <form id="filterForm" method="get" action="" class="flex flex-wrap gap-2 items-end flex-1">
            ...
            <div class="flex gap-2 items-end">
                ...
                <?php if (!empty($_GET)): ?>
                    <a href="/reports/budget" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition">Reset</a>
                <?php endif; ?>
            </div>
        </form>
    ...
    <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="flex items-center p-6 bg-blue-50 border-2 border-blue-300 rounded-2xl shadow-lg min-h-[120px] h-[140px]">
            ...
            <div>
                <div class="text-base font-bold text-blue-800 mb-1 tracking-wide">Total Budget</div>
        ...
        <div class="flex items-center p-6 bg-green-50 border-2 border-green-300 rounded-2xl shadow-lg min-h-[120px] h-[140px]">
            ...
            <div>
                <div class="text-base font-bold text-green-800 mb-1 tracking-wide">Total Aktual</div>
        ...
        <!-- Selisih Card -->
        <div class="flex items-center p-6 bg-purple-50 border-2 border-purple-300 rounded-2xl shadow-lg min-h-[120px] h-[140px]">
            <div class="flex items-center justify-center w-16 h-16 rounded-full bg-purple-200 mr-5">
                <svg class="w-10 h-10 text-purple-700" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20 12H4M12 4v16"/>
                </svg>
            </div>
            <div>
                <div class="text-base font-bold text-purple-800 mb-1 tracking-wide">Selisih Budget</div>
