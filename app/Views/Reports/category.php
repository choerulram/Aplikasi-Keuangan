            ...
            <table class="min-w-full border border-gray-300">
                <thead class="bg-main/90">
                    <tr>
                        ...
                        <th class="w-1/3 px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider border-r border-white/10">Kategori</th>
                ...
                <tfoot class="bg-main/90">
                    <tr>
                        <td colspan="3" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-white text-right border-r border-white/10">Total</td>
